...
from shared import assert_output_equals, assert_outputs_equal
import sys
import os
...
def a_pulumi_vpc():
    ...
    def default_vpc_args(pulumi_set_mocks):
        return vpc.VpcComponentArgs(
            vpc_name="test-vpc",
            cidr_block="1.2.3.4",
        )

    @pytest.fixture
    def sut(default_vpc_args: vpc.VpcComponentArgs):
        return vpc.VpcComponent(default_vpc_args)
